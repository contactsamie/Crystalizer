...
(function () {
    ...
    this.Crystalize = {
        ...
        setUp: function (o) {
            var newApiObject = o ? $.extend(new internal.CreateAPI().api, o) : false;
        },
        result: [],
    ...
    var InternalFactory = function (that) {
        ...
        this.globalSettings = {
            ...
            wholeInternalHandler: function (othat, _status, _data, textStatus, jqXHR) {
                ...
                //*in,#SelectJobProfile,dto$combobox=GroupTesting,none,#SelectJobProfile option=propose1
                ...
                if (clientHandlingMethod !== "") {
                    ...
                    for (var tie = 0; tie < tots; tie++) {
                        ...
                        clientHandlingMethodi.substring(0,1)==="*" ? internal.globalSettings.internalHandler(_data, x, y, z, w, r) : internal.globalSettings.evalAFunction(clientHandlingMethodi, _data);
